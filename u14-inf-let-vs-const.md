...
```javascript
let age = 16; // Assigning the value 16 to the box labeled "age"
console.log(age); // Output: 16
age = 18; // Replacing the old value (16) with 18 
console.log(age); 
// Output: 18
```
...
```javascript
const PI = 3.14; // Setting the value of PI (in a locked box) to 3.14
console.log(PI); // Output: 3.14 

PI = 22/7; // This will generate an error because you can't change the value in a const (locked) box
console.log(PI); // This line of code won't execute (run) because of the error on previous line
```
